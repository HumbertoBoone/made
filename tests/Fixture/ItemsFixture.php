...
class ItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'short_description' => ['type' => 'string', 'length' => 350, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'price' => ['type' => 'decimal', 'length' => 15, 'precision' => 2, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        '_indexes' => [
            ...
            'fk_items_brands1_idx' => ['type' => 'index', 'columns' => ['brand_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'sku_UNIQUE' => ['type' => 'unique', 'columns' => ['sku'], 'length' => []],
            'fk_items_brands1' => ['type' => 'foreign', 'columns' => ['brand_id'], 'references' => ['brands', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
