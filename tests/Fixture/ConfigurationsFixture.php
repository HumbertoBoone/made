...
class ConfigurationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'configuration_group_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'fk_configurations_configuration_groups1_idx' => ['type' => 'index', 'columns' => ['configuration_group_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_configurations_configuration_groups1' => ['type' => 'foreign', 'columns' => ['configuration_group_id'], 'references' => ['configuration_groups', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
